...
"""
    this function gets filename from command line and return it as str
"""
def arg_parse_foo():
...
"""
    this function gets abs as string got from input file and return a and b as
    float array
"""
def get_abc(ab_str):
    ab = ab_str.split()
...
"""
    this function is responsible for reading content of file got from command line
"""
def read_from_file():
    try:
...
"""
    this function is responsible for comparing result with the one from golden.txt
"""
def test(arg_num):
    try:
...
"""
    this function gets ab as float array and return solution as float
"""
def solve(ab):
    try:
        if 0 == ab[0]:
...
"""
    this function gets the result of solution and generates an output.txt
    containing the result with feedback
"""
